...
echo Running SSAKE in targeted de novo assembly mode, not restricted to target sequence space -i 0
../SSAKE -s fusion-targets.fa -f SRR066437.fastqc20q20e33.fa -m 16 -c 1 -b targetedUnrestricted -w 1
echo Running SSAKE in targeted de novo assembly mode, restricted to target sequence space -i 1 
../SSAKE -s fusion-targets.fa -f SRR066437.fastqc20q20e33.fa -m 16 -c 1 -i 1 -b targetedRestricted -w 1
